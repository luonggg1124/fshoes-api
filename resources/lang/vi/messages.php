...
return [
    ...
    'create_sale_request' => [
        ...
        'type.in' => 'Loại khuyến mãi phải là cố định hoặc phần trăm.',
        'value.number' => 'Giá trị khuyến mãi phải là một số.',
        'start_date.date' => 'Ngày bắt đầu phải là một ngày hợp lệ.',
        'start_date.before' => 'Ngày bắt đầu không được sau ngày kết thúc.',
    ],
    'update_sale_request' => [
        'name.string' => 'Tên khuyến mãi phải là một chuỗi.',
        'type.in' => 'Loại khuyến mãi phải là cố định hoặc phần trăm.',
    ...
    'create_variation_request' => [
        'variations.*.price.required' => 'Giá sản phẩm là bắt buộc.',
        'variations.*.stock_qty.required' => 'Số lượng hàng tồn kho là bắt buộc.',
        'variations.*.stock_qty.numeric' => 'Số lượng hàng tồn kho phải là một số.',
    ],
    'update_variation_request' => [
        'price.required' => 'Giá biến thể là bắt buộc.',
        'stock_qty.required' => 'Số lượng hàng tồn kho biến thể là bắt buộc.',
        'stock_qty.numeric' => 'Số lượng hàng tồn kho biến thể phải là một số.',
    ],
    'create_product_request' => [
        'name.required' => 'Tên sản phẩm là bắt buộc.',
        'name.string' => 'Tên sản phẩm phải là một chuỗi.',
        'name.max' => 'Tên sản phẩm quá dài; tối đa là 255 ký tự.',
        'price.required' => 'Giá sản phẩm là bắt buộc.',
        'stock_qty.required' => 'Số lượng hàng tồn kho là bắt buộc.',
        'stock_qty.numeric' => 'Số lượng hàng tồn kho phải là một số.',
        'image_url.required' => 'Hình ảnh sản phẩm là bắt buộc.',
        'image_url.string' => 'Không tìm thấy hình ảnh sản phẩm. Thử lại!',
    ],
    ...
    'create_order_request' => [
        ...
        'shipping_cost.required' => 'Phí vận chuyển là bắt buộc.',
        'amount_collected.required' => 'Số tiền thu được là bắt buộc.',
        "receiver_full_name.required" => "Họ và tên người nhận là bắt buộc.",
