...
class OrderService implements OrderServiceInterface
{
    ...
    {
        $orders = $this->orderRepository->query()->with(['orderDetails' , 'orderHistory' ,'user', 'orderDetails.product', 'orderDetails.variation' ]);
    ...
    {
        $cart = $this->orderRepository->query()->where('id', $id)->with(["orderDetails" , 'orderHistory' , 'user' , 'orderDetails.product', 'orderDetails.variation'])->first();
        if(!$cart){
